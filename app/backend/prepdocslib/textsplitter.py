...
DEFAULT_SECTION_LENGTH = 5000  # Roughly 400-500 tokens for English
...
class SentenceTextSplitter(TextSplitter):
    ...
    def __init__(self, has_image_embeddings: bool, max_tokens_per_section: int = 5000):
...
class SimpleTextSplitter(TextSplitter):
    ...
    def __init__(self, max_object_length: int = 5000):
